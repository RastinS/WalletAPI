...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(224, 247, 250, 0.3) 1px, rgba(224, 247, 250, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(224, 247, 250, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(224, 247, 250, 0.3), transparent);
}
