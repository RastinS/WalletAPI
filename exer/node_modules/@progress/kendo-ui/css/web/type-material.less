...
@button-background-color: contrast(@background, lighten(@background, 17%), darken(@background, 4%), 0.5);
...
@button-active-background: contrast(@background, lighten(@background, 23%), darken(@background, 16%), 0.5);
...
@button-focused-border-color: contrast(@background, lighten(@background, 23%), darken(@background, 20%), 0.5);
...
// Dialog
@dialog-button-stretched-padding-x: 15px;
...
@switch-on-handle-gradient: false;
...
@switch-on-handle-hovered-gradient: false;
...
@switch-off-handle-hovered-gradient: false;
