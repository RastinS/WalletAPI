...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(19), __webpack_require__(1520), __webpack_require__(1521), __webpack_require__(1498) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	        ...
	        isEditButton: function(x, y, pane) {
	            ...
	            if (ed) {
	                ...
	                if (y >= r.top && y <= r.bottom) {
	                    return pane._editorInLastColumn ? x < r.left && x >= r.left - 20
	        ...
	        objectAt: function(x, y) {
	            ...
	            if (x < 0 || y < 0 || x > this.scroller.clientWidth || y > this.scroller.clientHeight) {
	                ...
	                if (!pane) {
	                    ...
	                    if (type == "cell") {
	                        // when clicking on a merged cell, return the top-left one
	    ...
	    var Pane = kendo.Class.extend({
	        ...
	        renderData: function() {
	            ...
	            layout.cells.forEach(function(cell){
	                var cls = null;
	                if (cell.row + view.ref.topLeft.row == activeCell.row &&
	                    cell.col + view.ref.topLeft.col == activeCell.col)
	                {
