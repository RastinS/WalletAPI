...
.k-pager-wrap.k-pager-sm .k-pager-numbers {
  ...
  position: absolute;
  overflow: hidden;
  left: calc(4px + 1.5rem + 3em + 0.5625rem);
  ...
  border-style: solid;
  border-width: 1px;
  -webkit-transform: translateY(1px) translateY(0.375rem) translateY(0.75em) translateY(1px);
  -ms-transform: translateY(1px) translateY(0.375rem) translateY(0.75em) translateY(1px);
...
.k-pager-wrap.k-pager-sm .k-pager-numbers + .k-pager-input {
  margin-left: calc(4px + 1.5rem + 3em + 0.375rem + 2px);
}
...
[dir="rtl"] .k-pager-wrap.k-pager-sm .k-pager-numbers {
  left: auto;
  right: calc(4px + 1.5rem + 3em + 0.5625rem);
}
...
[dir="rtl"] .k-pager-wrap.k-pager-sm .k-pager-numbers + .k-pager-input {
  margin-left: 0;
  margin-right: calc(4px + 1.5rem + 3em + 0.375rem + 2px);
}
...
.k-rtl .k-pager-wrap .k-pager-numbers .k-current-page ~ li + li,
.k-pager-wrap[dir="rtl"] .k-pager-nav + .k-pager-nav,
...
.k-toolbar .k-split-button.k-state-disabled:focus,
.k-toolbar .k-split-button.k-state-disabled.k-state-focused {
  box-shadow: 0 0 0 3px rgba(228, 231, 235, 0.5);
}
.k-spreadsheet {
  width: 800px;
...
.k-notification-wrap {
  padding: 0.75rem 1.25rem;
  padding-right: calc(1.75rem + 16px);
  font-size: 0.875rem;
  white-space: nowrap;
  cursor: default;
  position: relative;
...
.k-rtl .k-notification .k-notification-closable > .k-notification-wrap {
  padding-left: calc(1.75rem + 16px);
  padding-right: 1.25rem;
}
.k-notification-wrap > .k-i-close,
.k-notification-wrap > .k-i-group-delete::before {
