...
td.k-state-focused.k-state-selected {
  box-shadow: inset 0 0 3px 1px #464646;
}
...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(129, 129, 129, 0.3) 1px, rgba(129, 129, 129, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(129, 129, 129, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(129, 129, 129, 0.3), transparent);
}
